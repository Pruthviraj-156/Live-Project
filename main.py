...
# Filters
select_year = Preprocessor.multiselect("Select Year", df["Financial_Year"].unique())
...
filtered_df = df[(df["Financial_Year"].isin(select_year))&
...
# KPI - Key Performance Indicatour
...
# Visualization to anlyze month- on-month sales data trends
